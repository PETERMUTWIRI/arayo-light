  ...
  return (
    <main className="min-h-screen">
      ...
      >
        ...
        <div className="pt-28 md:pt-32 lg:pt-40 pb-8 md:pb-16 lg:pb-20">
          <div className="container-care mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              <FadeIn>
                ...
                <h1 className="font-heading text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-care-navy mb-5 leading-tight tracking-tight">
