...
export default function AssessmentPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-hero pt-32 md:pt-40 pb-16 md:pb-24">
      <div className="container-care mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-10 md:mb-14">
          <FadeIn>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-care-red/8 text-care-red text-sm font-semibold mb-6 border border-care-red/10">
              ...
              <span>Free Care Assessment</span>
            </div>
            <h1 className="font-heading text-4xl md:text-5xl text-care-navy mb-4">
              Find the Right{' '}
        ...
        <div className="max-w-2xl mx-auto mb-10">
          ...
          <div className="h-3 bg-care-gray-200 rounded-full overflow-hidden">
            <motion.div 
              className="h-full bg-care-red rounded-full"
              initial={{ width: 0 }}
        ...
        <div className="max-w-2xl mx-auto">
          <div className="card-care p-6 md:p-10 min-h-[420px] relative overflow-hidden">
              ...
              {!showResult ? (
                ...
                >
                  <div className="flex items-center gap-4 mb-2">
                    <div className="w-12 h-12 rounded-xl bg-care-red/10 flex items-center justify-center">
                ...
                >
                  ...
                  <div className="bg-care-gray-50 rounded-2xl p-6 border border-care-gray-100">
                    <p className="text-care-gray-500 leading-relaxed">
                      {result!.description}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      {result!.services.map((service) => (
                        <div key={service.name} className="flex items-start gap-3 p-4 bg-white rounded-xl border border-care-gray-100">
